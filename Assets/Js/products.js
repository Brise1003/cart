            ...
            Array.from(json).forEach((p, index) => { //Toma el JSON, si es un arreglo haces el forEach. Si no lo es, mandas el error.
                div_Productos.innerHTML += `
                    ...
                    <div class="card mb-4 shadow-sm">
                        <img class="bd-placeholder-img card-img-top" id="producto__img" role="img" src="img/${p.url_Imagen}" />
                        <div class="card-body">
                        <p class="card-text" id="produto__title"><strong>${p.nombre}</strong></p>
                        <p class="card-text" id="producto-description">${p.descripcion}</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                            <button type="button" class="btn btn-sm btn-outline-secondary" id="btnVer_${p.id}" onclick="view(${index});">Ver</button>
                            <button type="button" class="btn btn-sm btn-outline-secondary"><a class="add-cart cart1" onclick="addcart()">Agregar</a></button>
                            <h5 class="card-text">$90.00 <a class="add-cart cart1" href="#"><i class="produto__icon fas fa-cart-plus"><img src="./Assets/Img/carrito.jpeg" alt=""
                            class="img_carrito"></i></a>
                            <input type="hidden" value="90" /></h5>
                            </div>
                    ...
                    <div class="produto">
                    <div class="card-body">
                      <img src="./Assets/Img/cerveza1.jpeg" class="produto__img">
                      <div class="productDescription">
                
                        <h4 class="produto__title">${p.nombre}</h4>
                        <h6 id="producto-description">${p.descripcion}</h6>
                          <h5 class="card-text">$90.00 <a class="add-cart cart1" href="#"><i class="produto__icon fas fa-cart-plus"><img src="./Assets/Img/carrito.jpeg" alt=""
                            class="img_carrito"></i></a>
                            <input type="hidden" value="90" /></h5>
                      </div>
...
// function addcart(){
//   <h5 class="card-text">$90.00 <a class="add-cart cart1" href="#"><i class="produto__icon fas fa-cart-plus"><img src="./Assets/Img/carrito.jpeg" alt="" class="img_carrito"></i></a>
//     <input type="hidden" value="90" /></h5>
